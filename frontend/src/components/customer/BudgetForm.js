...
import { Box, Button, FormControl, FormHelperText, InputLabel, OutlinedInput, 
      ...
      <Stack spacing={2}>
        <Box sx={{ width: '370px', textAlign: "center" }}>
          ...
          <FormControl fullWidth>
            <InputLabel htmlFor="budget-adornment-amount">Budget</InputLabel>
            <OutlinedInput
        ...
        <Box  display="flex" justifyContent='space-between'>
          ...
          <Button 
            ...
            variant="contained" 
            onClick={onSubmit} 
            disabled={budget === '' || parseFloat(budget) <= 0 || parseFloat(budget) > 1000}  
            sx={{ width: '180px' }}
          >
            Yes
          </Button>
