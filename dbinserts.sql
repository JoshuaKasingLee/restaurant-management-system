...
INSERT INTO leaderboard_entry(id, email, score, time_played) values (1, 'monkey@gmail.com', 20, date(20220108::text)),
(2, 'koala@gmail.com', 50, date(20220108::text)), (3, 'tiger@gmail.com', 100, date(20220108::text));

INSERT INTO category(name, display_order, visible) values ('Sashimi', 1, TRUE);
INSERT INTO category(name, display_order, visible) values ('Noodle', 2, TRUE);
INSERT INTO category(name, display_order, visible) values ('Rice bowl', 3, TRUE);
INSERT INTO category(name, display_order, visible) values ('Dessert', 4, TRUE);
...
INSERT INTO menu_item(name, description, ingredients, cost, display_order, category, image, visible) values ('Toshikoshi soba', 'Noodle dish eaten in Japan on New Year's Eve', 'Soba noodles, Noodle soup base, Fish cake, Soy sauce, Prawn, Shichimi togarashi', 15.5, 41, (SELECT id from category WHERE name = 'Noodle'), null, TRUE);
...
INSERT INTO menu_item(name, description, ingredients, cost, display_order, category, image, visible) values ('Purin', 'Purin is the Japanese version of crème caramel. It’s rich, creamy, and impossible to resist.', 'Purin, Flan, Pudding, Crème Caramel', 14.5, 52, (SELECT id from category WHERE name = 'Dessert'), null, TRUE);
INSERT INTO menu_item(name, description, ingredients, cost, display_order, category, image, visible) values ('Coffee Jelly', 'Cubes of coffee-flavored jelly swimming in thick sweetened cream: that’s what I call the perfect combination.', 'Coffee, Jelly, Cream', 16, 53, (SELECT id from category WHERE name = 'Dessert'), null, TRUE);
...
INSERT INTO menu_item(name, description, ingredients, cost, display_order, category, image, visible) values ('Green Tea Icecream', 'This ice cream is subtly sweet with bitter and smoky undertones. It’s an excellent treat for those who can’t stand overly sweet and rich desserts! ', 'Matcha powder, Ice cream', 18, 55, (SELECT id from category WHERE name = 'Dessert'), null, TRUE);
INSERT INTO menu_item(name, description, ingredients, cost, display_order, category, image, visible) values ('Rice Krispies Candy Sushi', 'Here’s another sweet sushi: rice gummy candies and Rice Krispies topped wrapped in fruit roll-ups. ', 'Rice gummy candies, Fruit roll-up', 16, 56, (SELECT id from category WHERE name = 'Dessert'), null, TRUE);
